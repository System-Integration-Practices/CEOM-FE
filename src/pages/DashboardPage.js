...
const DashboardPage = () => {
  ...
  useEffect(() => {
    async function fetchCampaigns() {
      console.log(
        `/personal_integration?fullName=${pagination.query}&benefitPlanId=&page=${pagination.currentPage}&limit=`
      );
      try {
        ...
        setPagination((item) => {
          return {
            ...
            itemsPerPage: response.data.itemPerPage,
            query: item.query,
          };
        });
  ...
  }, [pagination.currentPage, pagination.query]);
  return (
    <Fragment>
      <div className="flex items-center justify-between">
        <Heading number={4}>Your personals</Heading>
